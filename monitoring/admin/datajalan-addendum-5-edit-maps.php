...
<form class="form-horizontal" action="datajalan_edit_proses-5.php?kode_datajalan=<?php echo $kode_datajalan; ?>" enctype="multipart/form-data" method="post">
    <!-- Modal Popup Dosen -->
    ...
    <i class="fa fa-user-md"></i> S P M K</h3>
      ...
      <i class="fa fa-minus"></i></a>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3">
                <input id="spmk_lokasi_koordinat" name="spmk_lokasi_koordinat_lat"  type="text" class="form-control" value="<?php echo $res['spmk_lokasi_koordinat_lat']; ?>"/>
              </div>
              <label class="col-sm-1 control-label">Longitude</label>
              <div class="col-sm-3">
                <input id="spmk_lokasi_koordinat" name="spmk_lokasi_koordinat_long"  type="text" class="form-control" value="<?php echo $res['spmk_lokasi_koordinat_long']; ?>"/>
              </div>
            </div>  
            ...
            <div class="form-group">
              <label class="col-sm-4 control-label">Latitude</label>
              <div class="col-sm-3">
                <input id="spmk_lokasi_koordinat" name="spmk_lokasi_koordinat_lat2"  type="text" class="form-control" value="<?php echo $res['spmk_lokasi_koordinat_lat2']; ?>"/>
              </div>
              <label class="col-sm-1 control-label">Longitude</label>
              <div class="col-sm-3">
                <input id="spmk_lokasi_koordinat" name="spmk_lokasi_koordinat_long2"  type="text" class="form-control" value="<?php echo $res['spmk_lokasi_koordinat_long2']; ?>"/>
              </div>
            </div>  
            ...
            <div class="form-group">
              <label class="col-sm-4 control-label">Latitude</label>
              <div class="col-sm-3">
                <input id="spmk_lokasi_koordinat" name="spmk_lokasi_koordinat_lat3"  type="text" class="form-control" value="<?php echo $res['spmk_lokasi_koordinat_lat3']; ?>"/>
              </div>
              <label class="col-sm-1 control-label">Longitude</label>
              <div class="col-sm-3">
                <input id="spmk_lokasi_koordinat" name="spmk_lokasi_koordinat_long3"  type="text" class="form-control" value="<?php echo $res['spmk_lokasi_koordinat_long3']; ?>"/>
              </div>
            </div>  
            ...
            <div class="form-group">
              <label class="col-sm-4 control-label">Latitude</label>
              <div class="col-sm-3">
                <input id="spmk_lokasi_koordinat" name="spmk_lokasi_koordinat_lat4"  type="text" class="form-control" value="<?php echo $res['spmk_lokasi_koordinat_lat4']; ?>"/>
              </div>
              <label class="col-sm-1 control-label">Longitude</label>
              <div class="col-sm-3">
                <input id="spmk_lokasi_koordinat" name="spmk_lokasi_koordinat_long4"  type="text" class="form-control" value="<?php echo $res['spmk_lokasi_koordinat_long4']; ?>"/>
              </div>
            </div>  
        ...
        <div class="row">
            <div class="col-md-12">
              <div class="box box-danger">               
                ...
                <div id="dvMap" style="width: 1070px; height: 550px" ></div>
    ...
    // ----------------------------------------------------------- //
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-7 control-label">
             ...
             <!--    &nbsp; -->
                <!-- <a href='cetak-filter.php?kode_datajalan=<?php echo $res["kode_datajalan"]; ?>&&addendum=<?php echo $res["addendum"]; ?>' class="btn btn-info" ><i class="fa fa-print"></i>&nbsp; Cetak</a> -->
            </div>
