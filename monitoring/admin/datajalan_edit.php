...
<form class="form-horizontal" action="datajalan_edit_proses.php?kode_datajalan=<?php echo $kode_datajalan; ?>" enctype="multipart/form-data" method="post">
    <!-- Modal Popup Dosen -->
    ...
    <i class="fa fa-user-md"></i> Addendum Kontrak 2</h3>
      ...
      <i class="fa fa-minus"></i></a>
            ...
            <div class="form-group">
              <label class="col-sm-4 control-label">Nomor Kontrak Awal</label>
              <div class="col-sm-7">
                <input id="add2_no_kontrak" name="add2_no_kontrak" type="text"  class="form-control" value="<?php echo $res['add1_jenis_perkerasan_beton_desain']; ?>"/>
              </div>
            </div>
    ...
    <i class="fa fa-user-md"></i> Addendum Kontrak 3</h3>
      ...
      <i class="fa fa-minus"></i></a>
            ...
            <div class="form-group">
              <label class="col-sm-4 control-label">Nomor Kontrak Awal</label>
              <div class="col-sm-7">
                <input id="add3_no_kontrak" name="add3_no_kontrak" type="text"  class="form-control" value="<?php echo $res['add2_jenis_perkerasan_beton_desain']; ?>"/>
              </div>
            </div>
            ...
            <div class="form-group">
              <label class="col-sm-4 control-label">JENIS KONSTUKSI</label>
            </div>   
    ...
    <i class="fa fa-user-md"></i> Addendum Kontrak 4</h3>
      ...
      <i class="fa fa-minus"></i></a>
            ...
            <div class="form-group">
              <label class="col-sm-4 control-label">Nomor Kontrak Awal</label>
              <div class="col-sm-7">
                <input id="add4_no_kontrak" name="add4_no_kontrak" type="text"  class="form-control" value="<?php echo $res['add4_no_kontrak']; ?>"/>
              </div>
            </div>
            ...
            <div class="form-group">
                  ...
                  <div class="input-group date">
                    ...
                    <input id="Tanggal4" name="add4_tanggal" type="text" class="form-control" value="<?php echo $res['add4_tanggal']; ?>"/>
                  </div>
                  </div>
              </div>
