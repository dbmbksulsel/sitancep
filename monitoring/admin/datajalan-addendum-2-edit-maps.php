...
<form class="form-horizontal" action="datajalan_edit_proses-2.php?kode_datajalan=<?php echo $kode_datajalan; ?>" enctype="multipart/form-data" method="post">
    <!-- Modal Popup Dosen -->
    ...
    <i class="fa fa-user-md"></i> S P M K</h3>
      ...
      <i class="fa fa-minus"></i></a>
            ...
            <div class="form-group">
              <label class="col-sm-4 control-label">Latitude</label>
              <div class="col-sm-7">
                <input id="spmk_lokasi_koordinat4" name="spmk_lokasi_koordinat_lat4"  type="text" class="form-control" value="<?php echo $res['spmk_lokasi_koordinat_lat4']; ?>"/>
              </div>
            ...
            <div class="form-group">
              <label class="col-sm-4 control-label">Longitude</label>
              <div class="col-sm-7">
                <input id="spmk_lokasi_koordinat4" name="spmk_lokasi_koordinat_long4"  type="text" class="form-control" value="<?php echo $res['spmk_lokasi_koordinat_long4']; ?>"/>
              </div>
            </div> 
