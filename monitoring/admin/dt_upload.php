				...
				<tbody>
					<?php
						$querypelanggaransiswa = mysqli_query ($konek, "SELECT * FROM upload ");
						$no = 1;
						...
						while ($pelanggaransiswa = mysqli_fetch_array ($querypelanggaransiswa)){
							...
							echo "
								<tr>
									...
									<td>
										<a href='download.php?dow=".$pelanggaransiswa['filename']."' data-toggle='tooltip' title='Download' class='btn btn-xs btn-success' target='_blank'><span class='fa fa-cloud-download'></a>
