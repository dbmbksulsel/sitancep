...
<form class="form-horizontal" action="datajalan_add-4.php" method="post" enctype="multipart/form-data" >
    <!-- Modal Popup Dosen -->
    ...
    <div class="box-header with-border">
    <h3 class="box-title">
    <i class="fa fa-user-md"></i> Surat Perjanjian Kontrak Awal</h3>
      <a class="btn btn-default btn-sm pull-right" data-widget='collapse' data-toggle="tooltip" title="Collapse" style="margin-right: 5px;">
      <i class="fa fa-minus"></i></a>
    </div>   
    ...
    <i class="fa fa-user-md"></i> Addendum Kontrak 1</h3>
      ...
      <i class="fa fa-minus"></i></a>
            ...
            <div class="form-group">
              <label class="col-sm-4 control-label">Lebar Existing</label>
              <div class="col-sm-7">
                <input id="add1_jenis_perkerasan_beton_rencana" name="add1_jenis_perkerasan_beton_rencana"  type="text" class="form-control" placeholder="Lebar Existing" required/>
              </div>
            </div>    
    ...
    <i class="fa fa-user-md"></i> Addendum Kontrak 2</h3>
      ...
      <i class="fa fa-minus"></i></a>
            ...
            <div class="form-group">
              <label class="col-sm-4 control-label">Nomor Kontrak Awal</label>
              <div class="col-sm-7">
                <input id="add2_no_kontrak" name="add2_no_kontrak" type="text"  class="form-control" placeholder="Nomor" required/>
              </div>
            </div>
            ...
            <div class="form-group">
                  ...
                  <div class="input-group date">
                    ...
                    <input  name="add2_tanggal" type="date" class="form-control" placeholder="YYYY-MM-DD" data-toggle="tooltip" title="Format: mm/dd/yyyy"accept=" " required/>
                  </div>
                  </div>
              </div>
            ...
            <div class="form-group">
              <label class="col-sm-4 control-label">Waktu Pelaksanaan</label>
              <div class="col-sm-7">
                <input id="add2_waktu_pelaksanaan" name="add2_waktu_pelaksanaan"  type="text" class="form-control" placeholder="Waktu Pelaksanaan" required/>
              </div>
            </div>     
            ...
            <div class="form-group">
              <label class="col-sm-4 control-label">Perkerasan Aspal </label>
              <div class="col-sm-7">
                <input id="add2_panjang_perkerasan_aspal" name="add2_panjang_perkerasan_aspal"  type="text" class="form-control" placeholder="Perkerasan Aspal " required/>
              </div>
            </div>    
             ...
             <div class="form-group">
              <label class="col-sm-4 control-label">Perkerasan Beton </label>
              <div class="col-sm-7">
                <input id="add2_panjang_perkerasan_beton" name="add2_panjang_perkerasan_beton"  type="text" class="form-control" placeholder="Perkerasan Beton " required/>
              </div>
            </div>    
            ...
            <div class="form-group">
              <label class="col-sm-4 control-label">Lebar Existing</label>
              <div class="col-sm-7">
                <input id="add2_jenis_perkerasan_aspal_rencana" name="add2_jenis_perkerasan_aspal_rencana"  type="text" class="form-control" placeholder="Lebar Existing" required/>
              </div>
            </div>    
             ...
             <div class="form-group">
              <label class="col-sm-4 control-label">Lebar Desain</label>
              <div class="col-sm-7">
                <input id="add2_jenis_perkerasan_aspal_desain" name="add2_jenis_perkerasan_aspal_desain"  type="text" class="form-control" placeholder="Lebar Desain" required/>
              </div>
            </div>    
            ...
            <div class="form-group">
              <label class="col-sm-4 control-label">Lebar Existing</label>
              <div class="col-sm-7">
                <input id="add2_jenis_perkerasan_beton_rencana" name="add2_jenis_perkerasan_beton_rencana"  type="text" class="form-control" placeholder="Lebar Existing" required/>
              </div>
            </div>    
             ...
             <div class="form-group">
              <label class="col-sm-4 control-label">Lebar Desain</label>
              <div class="col-sm-7">
                <input id="add2_jenis_perkerasan_beton_desain" name="add2_jenis_perkerasan_beton_desain"  type="text" class="form-control" placeholder="Lebar Desain" required/>
              </div>
            </div>  
    ...
    <i class="fa fa-user-md"></i> Addendum Kontrak 3</h3>
      ...
      <i class="fa fa-minus"></i></a>
            ...
            <div class="form-group">
              <label class="col-sm-4 control-label">Nomor Kontrak Awal</label>
              <div class="col-sm-7">
                <input id="add3_no_kontrak" name="add3_no_kontrak" type="text"  class="form-control" placeholder="Nomor" required/>
              </div>
            </div>
            ...
            <div class="form-group">
                  ...
                  <div class="input-group date">
                   ...
                   <!--  <input id="Tanggal" name="add3_tanggal" type="text" class="form-control" placeholder="YYYY-MM-DD" required/> -->
                    <input  name="add3_tanggal" type="date" class="form-control" placeholder="YYYY-MM-DD" data-toggle="tooltip" title="Format: mm/dd/yyyy"accept=" " required/>
                  </div>
                  </div>
              </div>
            ...
            <div class="form-group">
              <label class="col-sm-4 control-label">Waktu Pelaksanaan</label>
              <div class="col-sm-7">
                <input id="add3_waktu_pelaksanaan" name="add3_waktu_pelaksanaan"  type="text" class="form-control" placeholder="Waktu Pelaksanaan" required/>
              </div>
            </div>   
            ...
            <div class="form-group">
              <label class="col-sm-4 control-label">Perkerasan Aspal </label>
              <div class="col-sm-7">
                <input id="add3_panjang_perkerasan_aspal" name="add3_panjang_perkerasan_aspal"  type="text" class="form-control" placeholder="Perkerasan Aspal " required/>
              </div>
            </div>    
             ...
             <div class="form-group">
              <label class="col-sm-4 control-label">Perkerasan Beton </label>
              <div class="col-sm-7">
                <input id="add3_panjang_perkerasan_beton" name="add3_panjang_perkerasan_beton"  type="text" class="form-control" placeholder="Perkerasan Beton " required/>
              </div>
            </div>    
            ...
            <div class="form-group">
              <label class="col-sm-4 control-label">Lebar Existing</label>
              <div class="col-sm-7">
                <input id="add3_jenis_perkerasan_aspal_rencana" name="add3_jenis_perkerasan_aspal_rencana"  type="text" class="form-control" placeholder="Lebar Existing" required/>
              </div>
            </div>    
             ...
             <div class="form-group">
              <label class="col-sm-4 control-label">Lebar Desain</label>
              <div class="col-sm-7">
                <input id="add3_jenis_perkerasan_aspal_desain" name="add3_jenis_perkerasan_aspal_desain"  type="text" class="form-control" placeholder="Lebar Desain" required/>
              </div>
            </div>    
            ...
            <div class="form-group">
              <label class="col-sm-4 control-label">Lebar Existing</label>
              <div class="col-sm-7">
                <input id="add3_jenis_perkerasan_beton_rencana" name="add3_jenis_perkerasan_beton_rencana"  type="text" class="form-control" placeholder="Lebar Existing" required/>
              </div>
            </div>    
             ...
             <div class="form-group">
              <label class="col-sm-4 control-label">Lebar Desain</label>
              <div class="col-sm-7">
                <input id="add3_jenis_perkerasan_beton_desain" name="add3_jenis_perkerasan_beton_desain"  type="text" class="form-control" placeholder="Lebar Desain" required/>
              </div>
            </div>  
    ...
    <i class="fa fa-user-md"></i> Addendum Kontrak 4</h3>
      ...
      <i class="fa fa-minus"></i></a>
            ...
            <div class="form-group">
              <label class="col-sm-4 control-label">Nomor Kontrak Awal</label>
              <div class="col-sm-7">
                <input id="add4_no_kontrak" name="add4_no_kontrak" type="text"  class="form-control" placeholder="Nomor" required/>
              </div>
            </div>
            ...
            <div class="form-group">
                  ...
                  <div class="input-group date">
                   ...
                   <!--  <input id="Tanggal" name="add4_tanggal" type="text" class="form-control" placeholder="YYYY-MM-DD" required/> -->
                    <input  name="add4_tanggal" type="date" class="form-control" placeholder="YYYY-MM-DD" data-toggle="tooltip" title="Format: mm/dd/yyyy"accept=" " required/>
                  </div>
                  </div>
              </div>
            ...
            <div class="form-group">
              <label class="col-sm-4 control-label">Waktu Pelaksanaan</label>
              <div class="col-sm-7">
                <input id="add4_waktu_pelaksanaan" name="add4_waktu_pelaksanaan"  type="text" class="form-control" placeholder="Waktu Pelaksanaan" required/>
              </div>
            </div>     
            ...
            <div class="form-group">
              <label class="col-sm-4 control-label">Perkerasan Aspal </label>
              <div class="col-sm-7">
                <input id="add4_panjang_perkerasan_aspal" name="add4_panjang_perkerasan_aspal"  type="text" class="form-control" placeholder="Perkerasan Aspal " required/>
              </div>
            </div>    
             ...
             <div class="form-group">
              <label class="col-sm-4 control-label">Perkerasan Beton </label>
              <div class="col-sm-7">
                <input id="add4_panjang_perkerasan_beton" name="add4_panjang_perkerasan_beton"  type="text" class="form-control" placeholder="Perkerasan Beton " required/>
              </div>
            </div>    
            ...
            <div class="form-group">
              <label class="col-sm-4 control-label">Lebar Existing</label>
              <div class="col-sm-7">
                <input id="add4_jenis_perkerasan_aspal_rencana" name="add4_jenis_perkerasan_aspal_rencana"  type="text" class="form-control" placeholder="Lebar Existing" required/>
              </div>
            </div>    
             ...
             <div class="form-group">
              <label class="col-sm-4 control-label">Lebar Desain</label>
              <div class="col-sm-7">
                <input id="add4_jenis_perkerasan_aspal_desain" name="add4_jenis_perkerasan_aspal_desain"  type="text" class="form-control" placeholder="Lebar Desain" required/>
              </div>
            </div>    
            ...
            <div class="form-group">
              <label class="col-sm-4 control-label">Lebar Existing(km)</label>
              <div class="col-sm-7">
                <input id="add4_jenis_perkerasan_beton_rencana" name="add4_jenis_perkerasan_beton_rencana"  type="text" class="form-control" placeholder="Lebar Existing" required/>
              </div>
            </div>    
             ...
             <div class="form-group">
              <label class="col-sm-4 control-label">Lebar Desain</label>
              <div class="col-sm-7">
                <input id="add4_jenis_perkerasan_beton_desain" name="add4_jenis_perkerasan_beton_desain"  type="text" class="form-control" placeholder="Lebar Desain" required/>
              </div>
            </div>  
      ...
      <i class="fa fa-minus"></i></a>
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              ...
              <div class="col-sm-7">
                <textarea id="spmk_lokasi_kabupaten" name="spmk_lokasi_kabupaten" type="text"  class="form-control" placeholder="Kabupaten/Kota beton" required> </textarea>
              </div>
            </div>    
