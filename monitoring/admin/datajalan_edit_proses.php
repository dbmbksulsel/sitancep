...
<?php
  ...
  {
    echo "<script>window.location = '1/index.php'</script>";
  }
?>
<?php
include "koneksi.php";
...
{ 
  ...
  $NIS                                          = mysqli_real_escape_string($konek, $_POST['NIS']);
  $Nama_Siswa                                   = mysqli_real_escape_string($konek, $_POST['Nama_Siswa']);
  $Kode_Kelas_Siswa                             = mysqli_real_escape_string($konek, $_POST['Kode_Kelas_Siswa']);
  $Kode_Jurusan_Siswa                           = mysqli_real_escape_string($konek, $_POST['Kode_Jurusan_Siswa']);
  $Tanggal_Lahir                                = mysqli_real_escape_string($konek, $_POST['Tanggal_Lahir']);
  $JK_Siswa                                     = mysqli_real_escape_string($konek, $_POST['JK_Siswa']);
  $No_Telp_Siswa                                = mysqli_real_escape_string($konek, $_POST['No_Telp_Siswa']);
  $Alamat_Siswa                                 = mysqli_real_escape_string($konek, $_POST['Alamat_Siswa']);
  $Ortu_Id_Siswa                                = mysqli_real_escape_string($konek, $_POST['Ortu_Id_Siswa']);
  $NIP_Siswa                                    = mysqli_real_escape_string($konek, $_POST['NIP_Siswa']);
  $No_Telp_Ortu_Siswa                           = mysqli_real_escape_string($konek, $_POST["No_Telp_Ortu_Siswa"]);
  $Password_Siswa                               = mysqli_real_escape_string($konek, $_POST['Password_Siswa']);
...
$spmk_lokasi_koordinat                = mysqli_real_escape_string($konek, $_POST["spmk_lokasi_koordinat"]);
 ...
 if(empty(
  ...
  empty($_POST['paket']) 
      ...
      window.location='datajalan_edit.php'</script>";      
    }else{ 
    //updating the table
    if ($result = mysqli_query($konek,"UPDATE datajalan SET 
              ...
              spmk_lokasi_koordinat ='$spmk_lokasi_koordinat'  
