        ...
        <div class="culmn">
            ...
            <section id="business" class="business bg-blue roomy-70">
                ...
                <div class="container">
                    ...
                    <div class="form">
                        <div class="header">
                            <h3 class="text-center" style="color: #18BC9C;">Enter Here to Login</h3>
                        </div>
                            <form style="margin-bottom: 0px !important;" class="form-horizontal" action="login_baru.php" method="post">
                                <div class="content">
                                    <h4 class="title"></h4>
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="input-group">
                                                    <input type="text" placeholder="Username" id="username" class="form-control" maxlength="50" name="username">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <input type="password" placeholder="Password" id="password" class="form-control" maxlength="50" name="password">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                       ...
                                       <div class="foot">
                                            <a href="register.php" class="btn btn-success"><span class="fa fa-plus"></span> Register</a>
                                            <button class="btn btn-danger" data-dismiss="modal" type="submit" name="login"><span class="fa fa-sign-in"></span><strong> L o g i n</strong></button>
                                        </div>
                            </form>
                    </div>
                </div> -->
<form class="form-horizontal" action="personil_add.php" method="post" enctype="multipart/form-data" >
    ...
    <h3 class="box-title">
    <i class="fa fa-file"></i> &nbsp; Data Personil</h3>
            ...
            <label class="col-sm-4 control-label"></label>
              <div class="col-sm-7">
                ...
                <input type="hidden"  value="RS<?php echo $id_personil; ?>" readonly="readonly" class="form-control" name="kode_personil" >
              </div>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input id="nama_pptk" name="pptk" type="text"  class="form-control" placeholder="Nama PPTK" required/>
              </div>
            </div>

            <div class="form-group">
              <label class="col-sm-4 control-label">Nama Pengawas</label>
              <div class="col-sm-5">
                <input id="pengawas" name="pengawas" type="text"  class="form-control" placeholder="Nama Pengawas" required/>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input id="rekanan" name="rekanan" type="text"  class="form-control" placeholder="Nama Rekanan" required/>
              </div>
            </div>

            <div class="form-group">
              <label class="col-sm-4 control-label">Nama Koordinator</label>
              <div class="col-sm-5">
                <input id="koordinator" name="koordinator" type="text"  class="form-control" placeholder="Nama Koordinator" required/>
              </div>
            </div>
            ...
            <div class="form-group">
               <div class="col-md-7 control-label">
                ...
                <!-- <a href="personil.php" class="btn btn-danger" ><i class="fa fa-backward"></i>&nbsp; Kembali</a> -->
            </div>
            </div>    
            </div>
